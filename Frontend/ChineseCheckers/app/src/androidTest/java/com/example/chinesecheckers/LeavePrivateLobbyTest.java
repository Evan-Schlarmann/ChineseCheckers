...
public class LeavePrivateLobbyTest {
    ...
    @Test
    public void leavePrivateLobbyTest() {
        ...
        ViewInteraction materialButton5 = onView(
                allOf(withId(R.id.leaveLobbyChatButton), withText("Return to lobby"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction button = onView(
                allOf(withId(R.id.chatWebsocketButton), withText("OPEN CHAT"),
                        withParent(allOf(withId(R.id.privateLobbyFrame),
                                withParent(withId(R.id.rea)))),
                        isDisplayed()));
        button.check(matches(isDisplayed()));

        ViewInteraction button2 = onView(
                allOf(withId(R.id.leavePrivateLobby), withText("LEAVE"),
                        withParent(allOf(withId(R.id.privateLobbyFrame),
                                withParent(withId(R.id.rea)))),
                        isDisplayed()));
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.HomePageHeader), withText("Chinese Checkers"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class))),
                        isDisplayed()));
        textView2.check(matches(withText("Chinese Checkers")));
    }
